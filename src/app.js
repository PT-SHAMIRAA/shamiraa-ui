...
export class App {
  ...
  configureRouter(config, router) {
    ...
    //   { route: 'shm-tb-bbt', name: 'shm-tb-bbt', moduleId: './modules/shm-tb-bbt-cr/index', nav: true, title: 'Pemasukan Barang Jadi', auth: true, settings: { group: "toko", roles: ["admin"] } },
    //   { route: 'shm-tb-bat', name: 'shm-tb-bat', moduleId: './modules/shm-tb-bat-cr/index', nav: true, title: 'Pemasukan Embalase', auth: true, settings: { group: "toko", roles: ["admin"] } },
    //   { route: 'shm-kb-rtp', name: 'shm-kb-rtp', moduleId: './modules/shm-kb-rtp-cr/index', nav: true, title: 'Retur Barang Ke Pusat', auth: true, settings: { group: "toko", roles: ["admin"] } },
