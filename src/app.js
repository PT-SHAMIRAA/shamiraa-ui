...
export class App {
  ...
  configureRouter(config, router) {
    ...
    //   { route: 'als-tb-bbt', name: 'als-tb-bbt', moduleId: './modules/als-tb-bbt-cr/index', nav: true, title: 'Pemasukan Barang Jadi', auth: true, settings: { group: "toko", roles: ["admin"] } },
    //   { route: 'als-tb-bat', name: 'als-tb-bat', moduleId: './modules/als-tb-bat-cr/index', nav: true, title: 'Pemasukan Embalase', auth: true, settings: { group: "toko", roles: ["admin"] } },
    //   { route: 'als-kb-rtp', name: 'als-kb-rtp', moduleId: './modules/als-kb-rtp-cr/index', nav: true, title: 'Retur Barang Ke Pusat', auth: true, settings: { group: "toko", roles: ["admin"] } },
