...
export class App {
  ...
  configureRouter(config, router) {
    ...
    //   { route: 'bts-tb-bbt', name: 'bts-tb-bbt', moduleId: './modules/shm-tb-bbt-cr/index', nav: true, title: 'Pemasukan Barang Jadi', auth: true, settings: { group: "toko", roles: ["admin"] } },
    //   { route: 'bts-tb-bat', name: 'bts-tb-bat', moduleId: './modules/shm-tb-bat-cr/index', nav: true, title: 'Pemasukan Embalase', auth: true, settings: { group: "toko", roles: ["admin"] } },
    //   { route: 'bts-kb-rtp', name: 'bts-kb-rtp', moduleId: './modules/shm-kb-rtp-cr/index', nav: true, title: 'Retur Barang Ke Pusat', auth: true, settings: { group: "toko", roles: ["admin"] } },
