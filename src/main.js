...
export async function configure(aurelia) {
  aurelia.use
    ...
    .plugin("aurelia-api", (config) => {
      ...
      var master = "https://com-shamiraa-service-core-dev.azurewebsites.net/v1/";
      var inventory = "https://com-shamiraa-service-warehouse-dev.azurewebsites.net/v1/";
      var merchandiser = "https://com-shamiraa-service-warehouse-dev.azurewebsites.net/v1/";
      var sales = "https://com-shamiraa-service-pos-dev.azurewebsites.net/v1/";
      //Config API
